...
const buildChatPanelPolicy = (userName: string) =>
  [
    ...
    "Write each section label on its own line exactly as written: Direct Answer / Source Evidence / Key Details / In Short.",
    "In Source Evidence, use bullets with citation tags like [1], [2], [3] mapped to explicit source section or question labels.",
